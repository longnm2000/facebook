  ...
  return (
    <div>
      ...
      <Container className="mt-5">
        <img
          src="https://pgdtxthuanan.edu.vn/wp-content/uploads/gai-xinh-trung-quoc.jpg"
          alt=""
        ...
        <div className="d-flex w-100 mt-3">
          <div className=" d-flex  align-items-center w-50 gap-2">
            ...
            />
            <div>
              <h2 className="text-wrap" title="Nguyễn Mạnh Long">
                Nguyễn Mạnh Long
              </h2>
              <p>50 bạn bè</p>
            </div>
          ...
          <div className="d-flex align-items-center justify-content-end w-50 gap-2">
            <button className="btn btn-primary">Thêm vào tin</button>
